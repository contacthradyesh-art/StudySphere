...
import {
  ...
  BookOpen, Sparkles, GraduationCap, BookHeart, Layers, Landmark, Languages, Settings
} from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col gap-1 border-r border-white/[0.06] bg-background/40 p-4 backdrop-blur-xl md:flex">
